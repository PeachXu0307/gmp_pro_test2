...
#define PGS_SINV_RC_COMMON_SDPE_PROJECT_UPDATED_AT "2026-07-27"
 ...
 */
#define SINV_CURRENT_LOOP_BANDWIDTH_HZ (200.0f)
 ...
 */
#define SINV_LEVEL1_VOLTAGE_REF_PU (0.10f)
...
#define SINV_DC_BUS_FEEDBACK_LPF_HZ (1000.0f)
#define SINV_DC_BUS_REF_SLEW_V_S (1.0f)

/**
 * @brief BUILD_LEVEL 2 peak current command with a resistive load.
 */
#define SINV_LEVEL2_CURRENT_REF_PEAK_PU (0.10f)
