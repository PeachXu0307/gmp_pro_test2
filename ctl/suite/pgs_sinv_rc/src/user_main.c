...
const gmp_param_item_t dict_m1[] = {
    ...
    {(void*)&g_sinv_ui_raw_key, GMP_PARAM_TYPE_U16, GMP_PARAM_PERM_RO},
    {(void*)&g_sinv_ui_pressed_key, GMP_PARAM_TYPE_U16, GMP_PARAM_PERM_RO},
    {(void*)&g_sinv_ui_output_request, GMP_PARAM_TYPE_U16, GMP_PARAM_PERM_RO},
    {(void*)&g_sinv_ui_key8_count, GMP_PARAM_TYPE_U32, GMP_PARAM_PERM_RO},
    {(void*)&g_sinv_ui_last_iic_ec, GMP_PARAM_TYPE_U16, GMP_PARAM_PERM_RO},
...
gmp_task_t tasks[] = {
    ...
    {"sinv_ui_key", tsk_sinv_ui_key, 50, 10, 0, (void*)&ht16k33},
    {"sinv_ui_display", tsk_sinv_ui_display, 100, 20, 0, (void*)&ht16k33},
    {"ctl_mainloop", tsk_ctl_main, 1, 0, 1, NULL},
...
gmp_task_status_t tsk_startup(gmp_task_t* tsk)
{
    ...
    static uint16_t startup_count = 0U;
