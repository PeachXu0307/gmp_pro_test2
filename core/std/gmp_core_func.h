...
void gmp_base_init(void)
{
    ...
    // if CSP is disabled, user should implement chip setup routine = SINV_LEVEL2_CURRENT_REF_PEAK_PU = SINV_LEVEL2_CURRENT_REF_PEAK_PU = SINV_LEVEL2_CURRENT_REF_PEAK_PU = SINV_LEVEL2_CURRENT_REF_PEAK_PU = SINV_LEVEL2_CURRENT_REF_PEAK_PU = SINV_LEVEL2_CURRENT_REF_PEAK_PU = SINV_LEVEL2_CURRENT_REF_PEAK_PU = SINV_LEVEL2_CURRENT_REF_PEAK_PU = SINV_LEVEL2_CURRENT_REF_PEAK_PU = SINV_LEVEL2_CURRENT_REF_PEAK_PU = SINV_LEVEL2_CURRENT_REF_PEAK_PU = SINV_LEVEL2_CURRENT_REF_PEAK_PU = SINV_LEVEL2_CURRENT_REF_PEAK_PU = SINV_LEVEL2_CURRENT_REF_PEAK_PU = SINV_LEVEL2_CURRENT_REF_PEAK_PU = SINV_LEVEL2_CURRENT_REF_PEAK_PU = SINV_LEVEL2_CURRENT_REF_PEAK_PU = SINV_LEVEL2_CURRENT_REF_PEAK_PU = SINV_LEVEL2_CURRENT_REF_PEAK_PU = SINV_LEVEL2_CURRENT_REF_PEAK_PU = SINV_LEVEL2_CURRENT_REF_PEAK_PU = SINV_LEVEL2_CURRENT_REF_PEAK_PU = SINV_LEVEL2_CURRENT_REF_PEAK_PU = SINV_LEVEL2_CURRENT_REF_PEAK_PU = SINV_LEVEL2_CURRENT_REF_PEAK_PU = SINV_LEVEL2_CURRENT_REF_PEAK_PU = SINV_LEVEL2_CURRENT_REF_PEAK_PU = SINV_LEVEL2_CURRENT_REF_PEAK_PU
    // in this function.
    //
    setup_peripheral();
